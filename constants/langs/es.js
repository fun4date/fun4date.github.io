export const es = {
    ...
    "publications": {
        "title": "Publicaciones",
        "description": "Este apartado es una recopilación de las publicaciones de todo el proyecto, tanto del equipo de la UPM, como de la UC3M, como publicaciones en conjunto. ",
        "filter":{
            "fieldTitle":"Buscar",
    ...
    "contact": {
        "title": "Contacto",
        "description": "Para consultas sobre este proyecto o solicitudes para futuras colaboraciones, puedes ponerte en contacto con los equipos de ambas universidades.",
